...
public final class CryptoServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "crypto.CryptoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.myservice.crypto.grpc.EncryptRequest,
      com.myservice.crypto.grpc.EncryptResponse> getEncryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Encrypt",
      requestType = com.myservice.crypto.grpc.EncryptRequest.class,
      responseType = com.myservice.crypto.grpc.EncryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.myservice.crypto.grpc.EncryptRequest,
      com.myservice.crypto.grpc.EncryptResponse> getEncryptMethod() {
    io.grpc.MethodDescriptor<com.myservice.crypto.grpc.EncryptRequest, com.myservice.crypto.grpc.EncryptResponse> getEncryptMethod;
      ...
      synchronized (CryptoServiceGrpc.class) {
        if ((getEncryptMethod = CryptoServiceGrpc.getEncryptMethod) == null) {
          CryptoServiceGrpc.getEncryptMethod = getEncryptMethod =
              io.grpc.MethodDescriptor.<com.myservice.crypto.grpc.EncryptRequest, com.myservice.crypto.grpc.EncryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Encrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myservice.crypto.grpc.EncryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myservice.crypto.grpc.EncryptResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.myservice.crypto.grpc.DecryptRequest,
      com.myservice.crypto.grpc.DecryptResponse> getDecryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Decrypt",
      requestType = com.myservice.crypto.grpc.DecryptRequest.class,
      responseType = com.myservice.crypto.grpc.DecryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.myservice.crypto.grpc.DecryptRequest,
      com.myservice.crypto.grpc.DecryptResponse> getDecryptMethod() {
    io.grpc.MethodDescriptor<com.myservice.crypto.grpc.DecryptRequest, com.myservice.crypto.grpc.DecryptResponse> getDecryptMethod;
    if ((getDecryptMethod = CryptoServiceGrpc.getDecryptMethod) == null) {
      synchronized (CryptoServiceGrpc.class) {
        if ((getDecryptMethod = CryptoServiceGrpc.getDecryptMethod) == null) {
          CryptoServiceGrpc.getDecryptMethod = getDecryptMethod =
              io.grpc.MethodDescriptor.<com.myservice.crypto.grpc.DecryptRequest, com.myservice.crypto.grpc.DecryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Decrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myservice.crypto.grpc.DecryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myservice.crypto.grpc.DecryptResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void encrypt(com.myservice.crypto.grpc.EncryptRequest request,
        io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.EncryptResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getEncryptMethod(), responseObserver);
    }

    /**
     */
    default void decrypt(com.myservice.crypto.grpc.DecryptRequest request,
        io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.DecryptResponse> responseObserver) {
  ...
  public static final class CryptoServiceStub
    ...
    /**
     */
    public void encrypt(com.myservice.crypto.grpc.EncryptRequest request,
        io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.EncryptResponse> responseObserver) {
    ...
    /**
     */
    public void decrypt(com.myservice.crypto.grpc.DecryptRequest request,
        io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.DecryptResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class CryptoServiceBlockingStub
    ...
    /**
     */
    public com.myservice.crypto.grpc.EncryptResponse encrypt(com.myservice.crypto.grpc.EncryptRequest request) {
    ...
    /**
     */
    public com.myservice.crypto.grpc.DecryptResponse decrypt(com.myservice.crypto.grpc.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CryptoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.myservice.crypto.grpc.EncryptResponse> encrypt(
        com.myservice.crypto.grpc.EncryptRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.myservice.crypto.grpc.DecryptResponse> decrypt(
        com.myservice.crypto.grpc.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ENCRYPT:
          serviceImpl.encrypt((com.myservice.crypto.grpc.EncryptRequest) request,
              (io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.EncryptResponse>) responseObserver);
          break;
        case METHODID_DECRYPT:
          serviceImpl.decrypt((com.myservice.crypto.grpc.DecryptRequest) request,
              (io.grpc.stub.StreamObserver<com.myservice.crypto.grpc.DecryptResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.myservice.crypto.grpc.EncryptRequest,
              com.myservice.crypto.grpc.EncryptResponse>(
                service, METHODID_ENCRYPT)))
        .addMethod(
          getDecryptMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.myservice.crypto.grpc.DecryptRequest,
              com.myservice.crypto.grpc.DecryptResponse>(
  ...
  private static abstract class CryptoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.myservice.crypto.grpc.CryptoProto.getDescriptor();
    }
